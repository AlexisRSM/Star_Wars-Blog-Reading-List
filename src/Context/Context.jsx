...
return (
    <FunctionContext.Provider value={{data,setData,fetchData,planets,setPlanets,fetchDataPlanets,vehicles,setVehicles,fetchDataVehicles,favorites,favoritesReducer}}>
        {children}
